...
const KanbanBoard = () => {
  const [columns, setColumns] = useState({
    "column-1": { name: "To Do", tasks: [], newTaskTitle: "" },
    "column-2": { name: "In Progress", tasks: [], newTaskTitle: "" },
    "column-3": { name: "Done", tasks: [], newTaskTitle: "" },
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-100 to-blue-200 p-6">
      <h1 className="text-4xl font-bold mb-8 text-center text-blue-700">Kanban Board</h1>
            ...
            <Droppable key={columnId} droppableId={columnId}>
              {(provided) => (
                <div
                  ...
                  className="w-72 bg-white rounded-xl shadow-lg p-4"
                >
                      ...
                      <Draggable key={task.id} draggableId={task.id} index={index}>
                        {(provided) => (
                          <div
                            ...
                            className="p-4 bg-blue-50 hover:bg-blue-100 rounded-lg shadow-md border border-blue-200 transition-transform transform hover:scale-105"
                          >
